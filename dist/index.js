...
// src/database/database.ts
var DramaEngineDatabase = class extends import_dexie.default {
...
var Prompter = class {
  ...
  constructor(config) {
    ...
    this.assemblePrompt = (companion, worldState, context, history, decorators = [], config = defaultPromptConfig, promptTemplate) => {
      ...
      let template = void 0;
      if (promptTemplate) {
        template = new import_jinja.Template(promptTemplate.chat_template);
      }
...
var Drama = class _Drama {
  ...
  static async initialize(defaultSituation, companionConfigs, kyInstance = import_ky.default, additionalOptions) {
